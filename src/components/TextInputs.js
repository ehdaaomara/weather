...
const TextInputs = ({ placeholder, onChangeText, secureTextEntry, validation, storageKey, nameicon, error ,nameicon2,nameicon3}) => {
  ...
  return (
    <View style={[styles.container, error ? styles.errorContainer : null]}>
      <View style={[styles.inputContainer, error ? styles.errorInputContainer : null]}>
        <Feather
          name={nameicon}
          style={{ alignSelf: 'center', marginLeft: width * 0.03 }}
          color={'#181D26'}
          size={20}
        />
        <TextInput
